import cv2
import numpy as np
image = cv2.imread(r"C:\Users\VIJITHA REDDY\OneDrive\Pictures\Screenshots\Screenshot 2023-11-16 211035.png")
img2 = cv2.imread(r"C:\Users\VIJITHA REDDY\OneDrive\Pictures\Screenshots\tinytan.jpg")
